  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
          ...
          if(u_xlatb0)
      {
          ...
          u_xlatb10 = 9.99999975e-05<abs(_ViewOffset);
          
          u_xlatb2 = u_xlat9==0.0;
          
          u_xlat5.xyz = u_xlat1.xyz / float3(u_xlat9);
          
          u_xlat1.xyz = (int(u_xlatb2)) ? u_xlat1.xyz : u_xlat5.xyz;
          ...
          u_xlat0.xyz = (int(u_xlatb10)) ? u_xlat0.xyz : in_v.vertex.xyz;
          ...
          u_xlat1.x = (-in_v.normal.y);
          
          u_xlat1.y = (-in_v.texcoord1.y);
          
          u_xlat2.xz = in_v.normal.yx;
          
          u_xlat2.yw = in_v.texcoord1.yx;
          
          u_xlat2.xy = (int(u_xlatb6)) ? u_xlat1.xy : u_xlat2.xy;
          
          u_xlat1.xy = u_xlat2.zx * in_v.normal.zz;
          
          u_xlat0.xy = u_xlat1.xy * float2(float2(_WidthMultiplier, _WidthMultiplier)) + u_xlat0.xy;
          
          u_xlat0.xy = u_xlat2.wy + u_xlat0.xy;
          
          u_xlat2 = in_v.color * _Color;
          
          u_xlat6 = u_xlat9 + (-_FadeAlphaDistanceFrom);
          
          u_xlat9 = (-_FadeAlphaDistanceFrom) + _FadeAlphaDistanceTo;
          ...
          out_v.color.w = u_xlat6 * u_xlat2.w;
          
          u_xlat0.xy = u_xlat0.xy / _ScreenParams.xy;
          
          u_xlat0.xy = u_xlat0.xy * float2(2.0, 2.0) + float2(-1.0, -1.0);
          
          out_v.vertex.xy = u_xlat1.ww * u_xlat0.xy;

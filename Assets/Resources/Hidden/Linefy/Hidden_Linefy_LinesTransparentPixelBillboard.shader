  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d = in_f.texcoord1.y / _Feather;
          
          u_xlat1_d.y = in_f.texcoord.y / in_f.texcoord.z;
          
          u_xlat2_d = (-u_xlat1_d.y) + 1.0;
          
          u_xlat2_d = min(u_xlat2_d, u_xlat1_d.y);
          
          u_xlat0_d = u_xlat0_d * u_xlat2_d;
          
          u_xlat0_d = min(u_xlat0_d, 1.0);
          
          u_xlat1_d.x = in_f.texcoord.x;
          
          u_xlat1_d = texture(_MainTex, u_xlat1_d.xy);
          ...
          out_f.color.w = (u_xlatb2) ? u_xlat0_d : u_xlat1_d.w;

...
namespace Mod
{
    public class Barchan : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            RukaSprite.color = new Color(1f, 0f, 1f, 0f);
        ...
        public void OnCollisionEnter2D(Collision2D other)
        {
            ...
            if (Nullified == false)
            {
                if (Ruka.GetComponent<Rigidbody2D>().velocity.magnitude >= 2f & other.gameObject.GetComponent<LimbBehaviour>() != null)
                {
                    ...
                    other.gameObject.GetComponent<LimbBehaviour>().SkinMaterialHandler.AcidProgress += 0.4f;
                    other.gameObject.GetComponent<LimbBehaviour>().CirculationBehaviour.AddLiquid(Liquid.GetLiquid("ACID"), 1.4f);
                }

...
namespace Mod
{
    public class Borobreath : CanShoot
    {

        private GameObject Ruka;
        private PhysicalBehaviour physicalBehaviour;
        private GameObject RukaGlow;
        private Vector2 barrelPosition = new Vector2(1.3f, -0.35f);
        private Vector2 barrelDirection = Vector2.right;
        ...
        public void Start()
        {
            ...
            components.transform.localPosition = new Vector3(1.3f, -0.35f);
            beam = components.AddComponent<LineRenderer>();
            beam.SetPositions(new[] { Vector3.zero, Vector3.right * 0 });
            ...
            RukaGlow.transform.localPosition = new Vector3(1.3f, -0.35f);
        ...
        private IEnumerator Fire()
        {
            ...
            beam.startColor = new Color(255/255f, 0/255f, 0/255f);
            beam.endColor = new Color(255/255f, 127/255f, 0/255f);
            ...
            for (int i = 0; i < iterations; i++)
            {
                ...
                for (int n = 0; n < victimCount; n++)
                {
                    ...
                    ExplosionCreator.CreatePulseExplosion(victim.point, 100f, 1, true);

...
namespace Mod
{
    public class PawPaw2 : MonoBehaviour
    {
        ...
        public float ImpactStrength = 10000;
        ...
        private void Start()
        {
            ...
            spr.GetComponent<SpriteRenderer>().sprite = powersprites.PadCannon;
            spr.GetComponent<SpriteRenderer>().color = new Color(0.1f, 0.1f, 0.1f, 1f);

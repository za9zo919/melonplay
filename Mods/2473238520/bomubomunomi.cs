    ...
    public class bomubomunomi : MonoBehaviour
    {
      ...
      bool IsUsable = true;
        ...
        public void Awake()
        {
            ...
            handSprite.sprite = powersprites.Bomber1;
            handSprite.material = ModAPI.FindMaterial("VeryBright");
            handSprite.color = new Color(255f, 0f, 0f, 0.001f);
        ...
        public void OnCollisionEnter2D(Collision2D other)
        {
...

            {
              ...
              float force = 0.01f * (1 * other.relativeVelocity.magnitude);
        ...
        public void FixedUpdate()
        {
            ...
            if (Activated)
            {
                ...
                handGlow.GetComponent<SpriteRenderer>().color = new Color(255f, 0f, 0f, Mathf.Clamp(gameObject.GetComponent<Rigidbody2D>().velocity.magnitude / 0.0099f, 0.0099f, 0.0099f));
            }
            else
            {

                handGlow.GetComponent<SpriteRenderer>().color = new Color(255f, 0f, 0f, 0f);
            }
        }

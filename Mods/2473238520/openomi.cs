...
namespace Mod
{
    public class openomi : MonoBehaviour
    {
      ...
      bool IsUsable = true;
        ...
        public void Awake()
        {
            ...
            handSprite.sprite = powersprites.Opecon;
        ...
        public void OnCollisionEnter2D(Collision2D other)
        {
            ...
            {
              other.gameObject.GetComponent<LimbBehaviour>().Damage(1f);
              other.gameObject.GetComponent<LimbBehaviour>().SkinMaterialHandler.ShotDamage(12f, transform.position, false);
              other.gameObject.GetComponent<LimbBehaviour>().CirculationBehaviour.Cut(transform.position, UnityEngine.Random.insideUnitCircle);
        ...
        public void FixedUpdate()
        {
            ...
            if (Activated)
            {
                ...
                handGlow.GetComponent<SpriteRenderer>().color = new Color(0f, 255f, 255f, Mathf.Clamp(gameObject.GetComponent<Rigidbody2D>().velocity.magnitude / 0.0099f, 0.0099f, 0.0099f));
            }
            else
            {

                handGlow.GetComponent<SpriteRenderer>().color = new Color(0f, 255f, 255f, 0f);
            }
        }
